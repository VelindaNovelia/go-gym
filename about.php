    ...
    <div class="bg-white py-5">
      <div class="container py-5">
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6 px-7 mx-auto order-1 order-lg-2"><img src="img/gym_community.jpg" alt=""
              class="img-fluid mb-1 mb-lg-1"></div>
        </div>
        <div class="row align-items-center">
          ...
          <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
            ...
            <p class="font-italic text-muted mb-4">Jl. Cibogo I No.9, Sukawarna, Sukajadi, Kota Bandung, Jawa Barat,
              40164</p>
            <a href="https://www.google.com/maps/place/Jl.+Cibogo+I+No.9,+Sukawarna,+Kec.+Sukajadi,+Kota+Bandung,+Jawa+Barat+40164/@-6.8869371,107.5762468,17z/data=!3m1!4b1!4m5!3m4!1s0x2e68e680c74cc479:0xf0453d4bfb91dae2!8m2!3d-6.8869424!4d107.5788217?entry=ttu"
              target="_blank" class="btn btn-warning px-5 rounded-pill shadow-sm">Lihat Lokasi</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container py-5">
        ...
        <div class="row text-center">
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div data-aos="flip-up" data-aos-duration="1000" class="bg-white rounded shadow-sm py-5 px-4"><img
                src="img/velinabout.jpg" alt="" width="100"
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div data-aos="flip-up" data-aos-duration="1000" class="bg-white rounded shadow-sm py-5 px-4"><img
                src="img/valenabout.jpg" alt="" width="100"
                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div data-aos="flip-up" data-aos-duration="1000" class="bg-white rounded shadow-sm py-5 px-4"><img
                src="img/owenabout.jpg" alt="" width="100"
                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div data-aos="flip-up" data-aos-duration="1000" class="bg-white rounded shadow-sm py-5 px-4"><img
                src="img/yemmiabout.jpg" alt="" width="100"
                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
